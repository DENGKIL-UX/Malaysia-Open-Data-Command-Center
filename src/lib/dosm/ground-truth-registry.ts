...
export const GROUND_TRUTH_REGISTRY = {
  ...
  gdp_qtr: {
    ...
    fields: [
      ...
      { name: 'series_type', type: 'string', label: 'Series Type', choices: ['nominal', 'real', 'real_sa'], required: true },
    ...
    priority_order: 1,
    status: 'VERIFIED',
    notes: 'Quarterly GDP at current and constant prices. Use series_type=real for constant prices.',
  ...
  gdp_annual: {
    ...
    fields: [
      { name: 'date', type: 'date', label: 'Year', required: true },
      { name: 'series_type', type: 'string', label: 'Series Type', choices: ['nominal', 'real'], required: true },
      { name: 'value', type: 'number', label: 'GDP Value (RM Billion)', required: true },
    ],
    valueField: 'value',
    dateField: 'date',
